...
**(Jan 2019) Luminoth is not maintained anymore**. We recommend switching to Facebook's [Detectron2](https://github.com/facebookresearch/detectron2), which implements more modern algorithms supporting additional use cases.
